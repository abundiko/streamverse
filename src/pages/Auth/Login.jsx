  ...
  return (
    <AnimatedPage>
      ...
      <main className="Login">
        <section className="h-screen flex dark:text-text-light">
          ...
          <div className="h-full w-full md:w-1/2 flex justify-center md:justify-start items-center px-3 md:px-8 lg:px-10 2xl:px-16 ">
            <div className="max-w-[500px] 2xl:max-w-[700px]">
              <h1 className="font-extrabold text-3xl md:text-[4vw]">Welcome Back!</h1>
              ...
              <div className="flex justify-between">
                <Link className='hover:text-primary-light' to="/signup">Signup instead?</Link>
